...
void check_quadratic(int guess1, int guess2, int answer1, int answer2, int &score)
{
...
int main()
{
    ...
    while(reply == 'L' || reply == 'Q')
    {
        ...
        else
        {
            ...
            x1 = readint();// Use function to validate
			x2 = readint();
            check_quadratic(x1, x2, solution1, solution2,score);
		}
        cout << "Enter 'L'' to try a linear  and 'Q' to try a quadratic equation.\nAny other key to quit.";
        cin >> reply;
    }
